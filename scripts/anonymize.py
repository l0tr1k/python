# l0tr1k data anonymization script
# This script is used to anonymize data in a CSV file based on a metadata file that specifies the data type for each column.
# version 1.0
